...
# Added sphinx.ext.napoleon since using google-style docstrings.
extensions = [
    'sphinx.ext.autodoc',
    'sphinx.ext.napoleon',
    'sphinxarg.ext',
...
# Exclude is empty here but can exclude the tests directory via the last
# argument in the spinx-apidoc command. Here is it issued from the root
# doc directory:
